...
public class CSVParser_ESTest extends CSVParser_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      StringReader stringReader0 = new StringReader("~t.a{&/*W_SJ<Q");
  ...
  public void test04()  throws Throwable  {
      StringReader stringReader0 = new StringReader("~t.a{&/*W_SJ<Q");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 929L, (-6368L));
      cSVParser0.nextRecord();
      assertEquals((-6368L), cSVParser0.getRecordNumber());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, (-6368L), (-6368L));
      cSVParser0.nextRecord();
      assertEquals((-6368L), cSVParser0.getRecordNumber());
  }
  ...
  public void test09()  throws Throwable  {
      StringReader stringReader0 = new StringReader("~t.a{&/*W_SJ<Q");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 929L, 929L);
      cSVParser0.getRecords();
      long long0 = cSVParser0.getCurrentLineNumber();
      assertEquals(929L, cSVParser0.getRecordNumber());
      assertEquals(1L, long0);
  }
  ...
  public void test13()  throws Throwable  {
      File file0 = MockFile.createTempFile(")D%cb)|Y1", ")D%cb)|Y1");
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.INFORMIX_UNLOAD_CSV;
      CSVParser cSVParser0 = CSVParser.parse("8ZOC", cSVFormat0);
      cSVParser0.close();
      try { 
        cSVParser0.nextRecord();
  ...
  public void test17()  throws Throwable  {
      ...
      try {
        cSVParser0 = new CSVParser(pipedReader0, (CSVFormat) null, 912L, 912L);
        fail("Expecting exception: NullPointerException");
  ...
  public void test19()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("~t.a{&/*W_SJ<Q", cSVFormat0);
      cSVParser0.isClosed();
      assertEquals(0L, cSVParser0.getRecordNumber());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      CSVParser cSVParser0 = new CSVParser(stringReader0, cSVFormat0, 929L, (-6368L));
      cSVParser0.stream();
      assertEquals((-6369L), cSVParser0.getRecordNumber());
  }
  ...
  public void test25()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("0$G$i2uXpK6KY?", cSVFormat0);
  ...
  public void test28()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.ORACLE;
      CSVParser cSVParser0 = CSVParser.parse("Delimiter=<,> Escape=<> QuoteChar=<\"> QuoteMode=<MINIMAL> NullString=<N> RecordSeparator=<\n> SkipHeaderRecord:false", cSVFormat0);
  ...
  public void test29()  throws Throwable  {
      StringReader stringReader0 = new StringReader("vI\"MIQm{DXX9M(Z0raj");
      CSVFormat cSVFormat0 = CSVFormat.RFC4180;
      CSVParser cSVParser0 = cSVFormat0.parse(stringReader0);
      cSVParser0.getRecords();
      CSVParser.CSVRecordIterator cSVParser_CSVRecordIterator0 = cSVParser0.new CSVRecordIterator();
  ...
  public void test32()  throws Throwable  {
      ...
      cSVParser0.close();
      cSVParser0.getRecords();
      assertEquals(928L, cSVParser0.getRecordNumber());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      CSVParser cSVParser0 = CSVParser.parse("0$G$2uxpK6KY?", cSVFormat0);
